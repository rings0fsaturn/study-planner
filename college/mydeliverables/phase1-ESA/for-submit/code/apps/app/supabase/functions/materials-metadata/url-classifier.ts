// Server-side copy of classifyUrl — kept in sync with apps/app/src/onboarding/url-classifier.ts
// Duplicated because Edge Functions run in Deno, client runs in Vite/browser.
