...
| [APP][RESEARCH] | scoped-question-generation | GitHub **#62** filed + claimed 2026-09-11; **P1 done** (steer is no longer the material title, `META_BLOCKLIST` in both prompts, empty steer refused — live A/B: pre-fix steer → 5/5 front matter, chapter steer → 5/5 Chapter 5 body and a body-grounded question); **P2 done** (page provenance through ingestion + migration 029 applied; live re-ingest 754/754 chunks paged 1..572, page-bounded RPC verified inclusive); branch `phase2/issue-62-scoped-question-generation` off `237faf8`; next P3 (outline at ingestion, migration **030**). | active/scoped-question-generation/state.md |
