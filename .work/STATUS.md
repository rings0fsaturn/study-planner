...
| [APP][RESEARCH] | scoped-question-generation | GitHub **#62** filed + claimed 2026-09-11; **P1–P4 done** (steer fix + `META_BLOCKLIST`; page provenance + migration 029; outline at ingestion + migration 030; scope contract + chapter picker + scoped/spread retrieval, no new migration); P4 verified live — a Chapter 5 scope (pdf 156..213) grounds every citation in range, route matrix + browser click-through 3/3 at 1280/375; AC1/2/3/5/6 ticked, AC4 waits on P5 (pdf.js viewer). Branch `phase2/issue-62-scoped-question-generation` off `237faf8`. | active/scoped-question-generation/state.md |
