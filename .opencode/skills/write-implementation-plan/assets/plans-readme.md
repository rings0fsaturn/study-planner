...
`YYYY-MM-DD-<slug>.md` where the date is when the plan was *written* and the slug is a short kebab-case identifier of what's being built. For example: `2026-04-29-jwt-auth-middleware.md`.

For plans that need supporting assets (mermaid sources, fixtures, sample data), use a directory: `YYYY-MM-DD-<slug>/PLAN.md` plus the assets alongside.
