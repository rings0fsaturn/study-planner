#!/usr/bin/env python3
"""
update-index.py — upsert one file's row in .claude/memory/index.jsonl.

Called by the post-read-index.sh hook with a single file path argument.
Also usable directly by Claude in instruction-mode fallback:
    python3 .claude/hooks/update-index.py <path>
