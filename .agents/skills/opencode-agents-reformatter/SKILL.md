...
description: >
  Reformat Codex rule/guard .md files into opencode-compatible format.
  Use this skill whenever the user wants to: migrate AGENTS.md or rule files to
...
- Rule files use plain frontmatter: `name` + `description` only (drop Codex
...
- **Frontmatter fields** — remove any `type:` field (Codex artifact; not
