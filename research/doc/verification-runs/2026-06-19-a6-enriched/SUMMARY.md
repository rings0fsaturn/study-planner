...
### frozen
- `context_pred_mae`: Holm wins={'covariate_bayes': 3, 'eb_partial_pool': 3, 'enriched_shrink': 11, 'ewma': 1, 'oracle_calibration': 12}; significant not-win={'covariate_bayes': 5, 'eb_partial_pool': 5, 'enriched_shrink': 1, 'ewma': 9, 'kalman': 12, 'pooled_bayes': 1, 'sma': 10}
- `recovery_mae`: Holm wins={'enriched_shrink': 6, 'oracle_calibration': 12}; significant not-win={'covariate_bayes': 12, 'eb_partial_pool': 5, 'enriched_shrink': 6, 'ewma': 12, 'kalman': 12, 'sma': 10}

### reality
- `context_pred_mae`: Holm wins={'covariate_bayes': 3, 'eb_partial_pool': 3, 'enriched_shrink': 10, 'ewma': 1, 'oracle_calibration': 12, 'sma': 4}; significant not-win={'covariate_bayes': 7, 'eb_partial_pool': 8, 'kalman': 8, 'sma': 4}
- `recovery_mae`: Holm wins={'enriched_shrink': 3, 'oracle_calibration': 12}; significant not-win={'covariate_bayes': 9, 'eb_partial_pool': 12, 'enriched_shrink': 3, 'ewma': 12, 'kalman': 12, 'sma': 12}
