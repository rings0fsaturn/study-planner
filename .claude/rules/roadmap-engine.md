...
Pure function package (`@study-tracker/roadmap-engine`) — generates week-by-week study roadmaps. No side effects, no framework dependencies. Tested with Vitest + fast-check (property tests).
